    ...
    <section id="contact" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2rem] border border-[rgba(129,140,248,0.14)] bg-white/3 p-10 backdrop-blur-[28px] sm:p-12"
        >
          {/* Corner glows */}
          ...
          {/* Top shimmer */}
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-[rgba(129,140,248,0.4)] to-transparent" />

          <div className="relative">
            <p className="mb-8 max-w-140 text-[15px] leading-[1.75] text-white/55">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="mailto:kaungkhant.luke.dev@gmail.com"
